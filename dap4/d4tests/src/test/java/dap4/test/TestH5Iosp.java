...
public class TestH5Iosp extends DapSvcTestCommon {
  ...
  static protected class H5IospTest {
    ...
    H5IospTest(String dataset) {
      ...
      this.baselinepath = root + "/" + BASELINEDIR + "/" + dataset + ".hdf5";
    }
  ...
  @Test
  public void testH5Iosp() throws Exception {
  ...
  //////////////////////////////////////////////////
  // Primary test method
  boolean doOneTest(H5IospTest testcase) throws Exception {
    boolean pass = true;
  ...
  List<H5IospTest> locate(String prefix) {
