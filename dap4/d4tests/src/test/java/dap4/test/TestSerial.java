...
public class TestSerial extends DapSvcTestCommon {
  ...
  static protected final String alpha = "abcdefghijklmnopqrstuvwxyz" + "abcdefghijklmnopqrstuvwxyz".toUpperCase();
  ...
  public void setup() throws Exception {
    ...
    this.sourceurl = TdsTestDir.dap4TestServer;
  ...
  void defineAllTestcases(String root, String server) {
  ...
  boolean doOneTest(ClientTest testcase) throws Exception {
    ...
    for (int i = 0; i < constraints.length; i++) {
      ...
      String baselinefile = String.format("%s.nc.%s", testcase.baselinepath, EXTENSION);
      if (prop_baseline)
  ...
  ClientTest locate1(String prefix) {
  ...
  static protected boolean report(String msg) {
