...
public class TestServlet extends DapTestCommon {
  ...
  static protected class TestCase {
    ...
    static public void setRoots(String input, String baseline, String generate) {
      inputroot = input;
    ...
    public TestCase(String dataset, String extensions, boolean checksumming, Dump.Commands template) {
      this.title = dataset;
  ...
  public void setup() throws Exception {
     ...
     */
    {
      StandaloneMockMvcBuilder mvcbuilder = MockMvcBuilders.standaloneSetup(new Dap4Controller());
  ...
  void doOneTest(TestCase testcase) throws Exception {
    ...
    if (PARSEDEBUG)
      DOM4Parser.setGlobalDebugLevel(1);
  ...
  protected void defineAllTestcases() {
    this.alltestcases.add(new TestCase("test_fill.nc", "dmr,dap", true, // 0
        // S4
        new Dump.Commands() {
    ...
    this.alltestcases.add(new TestCase("test_one_var.nc", "dmr,dap", true, // 0
        // S4
        new Dump.Commands() {
          public void run(Dump printer) throws IOException {
            printer.startchecksum();
    ...
    this.alltestcases.add(new TestCase("test_opaque.nc", "dmr,dap", true, // 0
        // S4
        new Dump.Commands() {
          public void run(Dump printer) throws IOException {
            printer.startchecksum();
    ...
    this.alltestcases.add(new TestCase("test_opaque_array.nc", "dmr,dap", true, // 0
        // S4
        new Dump.Commands() {
          public void run(Dump printer) throws IOException {
            printer.startchecksum();
    ...
    this.alltestcases.add(new TestCase("test_one_vararray.nc", "dmr,dap", true, // 1
        // S4
        new Dump.Commands() {
          public void run(Dump printer) throws IOException {
            printer.startchecksum();
    ...
    this.alltestcases.add(new TestCase("test_enum.nc", "dmr,dap", true, //
        // S1
        new Dump.Commands() {
          public void run(Dump printer) throws IOException {
            printer.startchecksum();
    ...
    this.alltestcases.add(new TestCase("test_enum_2.nc", "dmr,dap", true, //
        // S1
        new Dump.Commands() {
          public void run(Dump printer) throws IOException {
            printer.startchecksum();
    ...
    this.alltestcases.add(new TestCase("test_enum_array.nc", "dmr,dap", true, // 3
        // 5 S1
        new Dump.Commands() {
          public void run(Dump printer) throws IOException {
            printer.startchecksum();
    ...
    this.alltestcases.add(new TestCase("test_atomic_types.nc", "dmr,dap", true, // 4
    ...
    this.alltestcases.add(new TestCase("test_atomic_array.nc", "dmr,dap", true, // 5
    ...
    this.alltestcases.add(new TestCase("test_groups1.nc", "dmr,dap", true, // 6
        // 5 S4 3 F4 5 S4 7 F4",
        new Dump.Commands() {
          public void run(Dump printer) throws IOException {
            printer.startchecksum();
    ...
    this.alltestcases.add(new TestCase("test_struct_type.nc", "dmr,dap", true, // 7
        // { S4 S4 }
        new Dump.Commands() {
          public void run(Dump printer) throws IOException {
            printer.startchecksum();
    ...
    this.alltestcases.add(new TestCase("test_utf8.nc", "dmr,dap", true, // 9
        // 2 { S4 S4 }
        new Dump.Commands() {
          public void run(Dump printer) throws IOException {
            printer.startchecksum();
    ...
    this.alltestcases.add(new TestCase("test_struct_nested.hdf5", "dmr,dap", true, // 10
        // { { S4 S4 } { S4 S4 } }
        new Dump.Commands() {
          public void run(Dump printer) throws IOException {
            printer.startchecksum();
    ...
    this.alltestcases.add(new TestCase("test_struct_nested3.hdf5", "dmr,dap", true,
        // { { {S4 } } }
        new Dump.Commands() {
          public void run(Dump printer) throws IOException {
            printer.startchecksum();
    ...
    this.alltestcases.add(new TestCase("test_sequence_1.syn", "dmr,dap", true, // 0
        // S4
        new Dump.Commands() {
          public void run(Dump printer) throws IOException {
            printer.startchecksum();
    ...
    this.alltestcases.add(new TestCase("test_sequence_2.syn", "dmr,dap", true, // 0
        // S4
        new Dump.Commands() {
          public void run(Dump printer) throws IOException {
            printer.startchecksum();
     ...
     * }));
     */
    this.alltestcases.add(new TestCase("test_anon_dim.syn", "dmr,dap", true, // 0
        // S4
        new Dump.Commands() {
          public void run(Dump printer) throws IOException {
            printer.startchecksum();
    ...
    this.alltestcases.add(new TestCase("test_atomic_types.syn", "dmr,dap", true, // 4
        // S1 U1 S2 U2 S4 U4 S8 U8 F4 F8 C1 T O S1 S1
        new Dump.Commands() {
          public void run(Dump printer) throws IOException {
            printer.startchecksum();
    ...
    this.alltestcases.add(new TestCase("test_atomic_array.syn", "dmr,dap", true, // 5
        // 6 U1 4 S2 6 U4 2 F8 2 C1 4 T 2 O 5 S1
        new Dump.Commands() {
          public void run(Dump printer) throws IOException {
            printer.startchecksum();
    ...
    this.alltestcases.add(new TestCase("test_struct_array.syn", "dmr,dap", true, // 8
        // 12 { S4 S4 }
        new Dump.Commands() {
          public void run(Dump printer) throws IOException {
            printer.startchecksum();
    ...
    // XFAIL tests
    this.alltestcases.add(new TestCase("test_struct_array.nc", "dmr", true));
  }
