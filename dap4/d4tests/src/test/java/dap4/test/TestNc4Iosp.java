...
public class TestNc4Iosp extends DapSvcTestCommon {
  ...
  static protected class Nc4IospTest {
    ...
    static public void setRoots(String input, String baseline) {
      inputroot = input;
  ...
  public void setup() throws Exception {
    ...
    testSetup();
    Nc4IospTest.setRoots(canonjoin(getResourceRoot(), TESTINPUTDIR), canonjoin(getResourceRoot(), BASELINEDIR));
    defineAllTestcases();
    chooseTestcases();
  }
  ...
  @Test
  public void testNc4Iosp() throws Exception {
  ...
  List<Nc4IospTest> locate(String prefix) {
